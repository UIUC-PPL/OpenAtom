      SUBROUTINE QLAG2( A, LDA, B, LDB, SAFMIN, SCALE1, SCALE2, WR1,
     $                  WR2, WI )
*
...
*     .. Scalar Arguments ..
      INTEGER            LDA, LDB
      REAL*16   SAFMIN, SCALE1, SCALE2, WI, WR1, WR2
*     ..
*     .. Array Arguments ..
      REAL*16   A( LDA, * ), B( LDB, * )
*     ..
...
*  =========
*
*  A       (input) REAL*16 array, dimension (LDA, 2)
...
*
*  B       (input) REAL*16 array, dimension (LDB, 2)
...
*
*  SAFMIN  (input) REAL*16
*          The smallest positive number s.t. 1/SAFMIN does not
*          overflow.  (This should always be DLAMCH('S') -- it is an
*          argument in order to avoid having to call DLAMCH frequently.)
*
*  SCALE1  (output) REAL*16
...
*     .. Parameters ..
      ...
      PARAMETER          ( ZERO = 0.0Q+0, ONE = 1.0Q+0, TWO = 2.0Q+0 )
      REAL*16   HALF
      PARAMETER          ( HALF = ONE / TWO )
      REAL*16   FUZZY1
      PARAMETER          ( FUZZY1 = ONE+1.0Q-5 )
*     ..
*     .. Local Scalars ..
      REAL*16   A11, A12, A21, A22, ABI22, ANORM, AS11, AS12,
