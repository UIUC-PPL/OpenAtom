...
This would work for us because of the erfc function in 3D allowing for a short range cutoff. Otherwise, this expansion is not good when $R_{ij}$ is large. Fig.P.4 also indicates the converge with $n_{\theta}$, $n_{\phi}$ does not depend on $n_r$, which is great!
