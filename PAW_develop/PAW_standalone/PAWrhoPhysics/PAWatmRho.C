...
//===================================================================================
void PAWATMRHO::readatoms(CELL *cell, ATOM_MAPS *atom_maps, NAME fnameIn, int NatmChunk)
  //===================================================================================
{//begin routine
  //===================================================================================
 ...
 // Read in the atoms and parameters
  FILE *fp = fopen(fnameIn,"r");
    ...
    for (int i=0; i<natm; i++) {
      fscanf(fp,"%lf %lf %lf %lf %lf %lf %d",&x[i],&y[i],&z[i], &q[i], &qt[i], &Rpc[i], &index_atm_typ[i]);
            readtoendofline(fp);
      alp[i] = 1.8/Rpc[i];
