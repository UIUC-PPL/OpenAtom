...
g++ -std=c++11 -Wall -g -O2 -o model_PAW.x model_PAW.C gen_Gauss_quad.o gen_Gauss_quad_driver.o GaussianPAW.o gen_fgrid.o gen_Ylmf.o grid.o quad_rule.o -lblas -llapack -lquadmath -lm
